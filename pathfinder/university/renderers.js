...
function renderDiscoverySelectorOptions() {
  ...
  console.log('renderDiscoverySelectorOptions called, SELECTOR_OPTIONS:', opts);
  ...
  Object.entries(opts).forEach(([qKey, options]) => {
    ...
    console.log(`  - ${qKey}: found container=${!!container}, options=${options?.length || 0}`);
    if (!container) return;
